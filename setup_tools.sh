...
echo "    python qa-bot/review.py repo repos/<name> -p wordpress  # Full review"
echo "    python qa-bot/review.py repo repos/<name> --tools-only  # Tools only (no GPU)"
echo ""
echo "  TIP: For Laravel projects, install Larastan in the project itself:"
echo "    cd repos/your-laravel-app"
